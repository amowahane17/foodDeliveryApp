    ...
    return (
      <ImageBackground
        ...
        {data[currIndex].top_img_two !== null && (
          <Image style={styles.burger} source={data[currIndex]?.top_img_two} />
        )}
        <View style={styles.bottomView}>
          ...
          <View style={styles.dotView}>
            <View
              style={[currIndex === 0 ? styles.redCircle : styles.greenCircle]}
            />
            <View
              style={[currIndex === 1 ? styles.redCircle : styles.greenCircle]}
            />
            <View
              style={[currIndex === 2 ? styles.redCircle : styles.greenCircle]}
            />
            <View
              style={[currIndex === 3 ? styles.redCircle : styles.greenCircle]}
            />
          </View>
        </View>
      </ImageBackground>
...
const styles = StyleSheet.create({
  ...
  burger: {position: 'absolute', top: '29%', right: '1%'},
